...
export class CreditCardPayment extends Payment {
    ...
    paymentResultValid(data: any): boolean {
        ...
        // Check for both legacy charge.succeeded and new Stripe Checkout events
        return (
            parsedData?.event === "charge.succeeded" ||
            parsedData?.paymentStatus === "paid" ||
            parsedData?.webhookEvent?.type === "checkout.session.completed"
        );
    }
